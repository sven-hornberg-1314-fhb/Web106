...
grails.project.fork = [
    ...
    run: [maxMemory: 512, minMemory: 64, debug: false, maxPerm: 512, forkReserve:false],
    // configure settings for the run-war JVM
    war: [maxMemory: 512, minMemory: 64, debug: false, maxPerm: 512, forkReserve:false],
...
grails.project.dependency.resolution = {
    ...
    plugins {
        ...
        //runtime ":yui-minify-ResourceHolder:0.1.5"
