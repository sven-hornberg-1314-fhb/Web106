		...
		<div id="list-box" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="idName" title="${message(code: 'box.idName.label', default: 'Id Name')}" />
				...
				<g:each in="${boxInstanceList}" status="i" var="boxInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${boxInstance.id}">${fieldValue(bean: boxInstance, field: "idName")}</g:link></td>
